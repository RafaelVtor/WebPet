...
<br><br>
 <h3 style=" width: 60%; color: black; margin-left: 14%;">Informações sobre:&nbsp&nbsp<b><?php echo $dado['nome']; ?></b></h3>
...
<center><a  href="editar_animal.php?animal=<?php echo $id_animal ?>" class="w3-btn w3-blue-grey"><b>Editar</b></a></button>
    <a href="perfil_principal.php" class="w3-btn w3-blue-grey">Voltar</a></center><p><br>
<br>
